...
SYMBOL_SCOPE = {
    ...
    "NOT_EQUAL": "keyword.operator.comparison.lynx",
    "ALMOST": "keyword.operator.comparison.lynx",
    "GREATER": "keyword.operator.comparison.lynx",
    "GREATER_OR_EQUAL": "keyword.operator.comparison.lynx",
    "GREATER_OR_ALMOST": "keyword.operator.comparison.lynx",
    "LESS": "keyword.operator.comparison.lynx",
    "LESSER_OR_EQUAL": "keyword.operator.comparison.lynx",
    "LESSER_OR_ALMOST": "keyword.operator.comparison.lynx",
    "PLUS": "keyword.operator.arithmetic.lynx",
    "MINUS": "keyword.operator.arithmetic.lynx",
    "POWER": "keyword.operator.arithmetic.lynx",
